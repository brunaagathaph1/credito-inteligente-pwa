...
import { PieChart as PieChartIcon, BarChart2, Users, DollarSign } from "react-feather";
...
const RelatoriosEGraficos = () => {
  ...
  const navigationItems = [
    { id: "status", label: "Status", icon: PieChartIcon },
    { id: "movimentacao", label: "Movimentação", icon: BarChart2 },
